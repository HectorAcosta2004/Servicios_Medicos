...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <aside
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link " href="../pages/dashboard_admin.php">
            <div
        ...
        <li class="nav-item active">
          <a class="nav-link active " href="../pages/Asignacion.php">
            <div
              class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link " href="../pages/ver_citas.php">
            <div
              class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Doctor Asignado
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    $sql = "SELECT s.service_id, s.name AS service_name, u.user_id, CONCAT(u.name, ' ', u.last_name) AS doctor_name 
            FROM service s 
  ...
  <script>
    function abrirModalEditar(serviceId, doctorId) {
  ...
  <div id="modalEditar" class="modal">
    <div class="modal-content">
      ...
      <form id="editForm" action="editar_asignacion.php" method="POST">
        <input type="hidden" name="service_id" id="editServiceId">
        <label for="editDoctor">Doctor:</label>
        <select name="user_id" id="editDoctor"></select>
  ...
  <div id="modalEliminar" class="modal">
    <div class="modal-content">
      ...
      <h3>¿Estás seguro de eliminar la asignación?</h3>
      <form action="eliminar_asignacion.php" method="POST">
